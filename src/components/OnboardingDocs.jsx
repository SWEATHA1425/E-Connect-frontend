...
export default function EmployeeDashboard() {
  ...
  `https://e-connect-backend-2l74.onrender.com/documents/assigned/${encodeURIComponent(userid)}`
      );
      ...
      <div className="flex items-center gap-3 text-sm">
        ...
        <button
          onClick={async () => {
            try {
              await axios.delete(
                `https://e-connect-backend-2l74.onrender.com/documents/delete/${doc.fileId}`
              );
